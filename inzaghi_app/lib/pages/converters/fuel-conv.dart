...
class FuelConv extends StatefulWidget {
  ...
  @override
  State<FuelConv> createState() => _FuelConvState();
}
...
class _FuelConvState extends State<FuelConv> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Fuel Converter'),
      ),
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        fuelsAbr[fuels.indexOf(selfuelsFrom!)],
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        fuelsAbr[fuels.indexOf(selfuelsTo!)],
                        style: const TextStyle(
                          color: Colors.black,
                          fontSize: 14,
                          fontWeight: FontWeight.normal,
